...
@section('content')
    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-6 max-w-screen-xl">
            ...
            <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 my-10">
                <div class="p-3">
    ...
    <!-- Adoption Process -->
    <section class="pt-[100px] pb-[250px] bg-white" id="adoption-form">
        <div class="container mx-auto px-6 max-w-screen-md">
            ...
            <div class="flex justify-between items-stretch mt-5 flex-wrap-reverse">

                <div class=" form-div-1 px-5">
                    <img src="{{ asset('cuidar_files/petpic.jpg') }}" class="h-full w-full object-top object-cover rounded-lg"
                        alt="Contact Form">
                </div>

                <form style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;" class="space-y-6 p-5 bg-gray-100 rounded-lg shadow-lg form-div-2">
                    ...
                    <button type="submit"
                        class="bg-green-700 w-full mt-5 hover:brightness-110 transition text-white font-bold py-3 px-6 rounded-full">Submit
                        Application</button>
                </form>
            </div>
        </div>
