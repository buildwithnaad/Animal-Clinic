...
<head>
    ...
    <link href="{{ url('assets/dashboard/libs/selectize/css/selectize.bootstrap3.css') }}" rel="stylesheet"
        type="text/css" />
    ...
    <link href="{{ url('assets/dashboard/css/bootstrap-dark.min.css') }}" rel="stylesheet" type="text/css"
        id="bs-dark-stylesheet" />
    <link href="{{ url('assets/dashboard/css/app-dark.min.css') }}" rel="stylesheet" type="text/css"
...
<body class="loading"
                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebarReports">
                                <ul class="nav-second-level">
                                    <li>
                                        <a target="_blank" href="{{ route('generate-pdf', ['type' => 2]) }}">
                                            All Procedures by Month/Client
                                        </a>
                                    </li>
                                    <li>
                                        <a target="_blank" href="{{ route('generate-pdf', ['type' => 1]) }}">
                                            Product Report
                                        </a>
                                    </li>
                                </ul>
    ...
    <script src="{{ url('assets/dashboard/libs/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js') }}">
    </script>
