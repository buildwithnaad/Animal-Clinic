...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <h4 class="page-title mt-4">Admin Panel</h4>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="card-body">
                <div class="apresentacao">
                    <h1 style="font-size: 25px;">Welcome, {{Auth::user()->name}}, to the Cuidar Admin Panel</h1>
                    <p>This is our <strong>admin panel</strong>. Here you can choose a desired option right on the side.<br/>
                        Select and execute functions easily that will help you during your work routine!
                    </p>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="text-md-right justify-content-end d-none d-sm-block">
                        <script>document.write(new Date().getFullYear())</script> - Developed by <strong><a href="https://porfiriodev.vercel.app/" target="_blank">Porfírio</a></strong>
                    </div>
                </div>
            </div>
        </div>
